...
function inferResourceType(item) {
    ...
    if (item.uri.startsWith("viking://session/"))
        return "session";
    if (item.uri.startsWith("viking://user/skills") || item.uri.startsWith("viking://~/skills") || item.uri.startsWith("viking://skills"))
        return "agent";
    if (item.uri.startsWith("viking://user/") || item.uri.startsWith("viking://~/"))
        return "user";
    return undefined;
}
