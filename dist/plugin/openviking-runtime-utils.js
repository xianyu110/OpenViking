...
export function inferRecallResourceType(uri) {
    ...
    if (uri.startsWith("viking://user/skills") || uri.startsWith("viking://~/skills") || uri.startsWith("viking://skills"))
        return "agent";
    if (uri.startsWith("viking://user/") || uri === "viking://~" || uri.startsWith("viking://~/"))
        return "user";
    return undefined;
}
